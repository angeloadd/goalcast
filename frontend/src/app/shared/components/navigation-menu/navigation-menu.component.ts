...
@Component({
    selector: 'gc-navigation-menu-item',
    host: { class: 'relative' },
    template: '<ng-content />',
...
@Component({
    selector: 'gc-navigation-menu-trigger',
    host: {
...
@Component({
    selector: 'gc-navigation-menu-content',
    host: {
...
@Component({
    selector: 'gc-navigation-menu-link',
    host: {
